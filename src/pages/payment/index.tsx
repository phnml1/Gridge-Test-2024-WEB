...
import { AppDownLoad, AppGuideMessage, Background, Box, CancelSubSribeButton, CheckTerms, InobelLogo, PaymentBox, PaymentWrap, SubSribeButton, SubSribePriceText, SubSribeText, Wrap } from "./styles";
  ...
  return (
    ...
    <PaymentWrap>
      ...
      <Box><PaymentBox>
        ...
        <SubSribePriceText>{(isSubscribe)?'서비스 구독중':'월 9,900원으로 구독하기'}</SubSribePriceText>
        { (isSubscribe)?
