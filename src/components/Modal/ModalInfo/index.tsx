...
const ModalInfo = (props: ModalInfoProps) => {
  ...
  return (<Wrap>
    <Icons>
    <HeartComment>{props.isLiked?(<HeartIcon onClick={()=>{addLike(modal)}} src = {fillHeart}/>):(<HeartIcon  onClick={()=>{addLike(modal)}} src = {heartIcon}/>)} <CommentIcon src = {commentIcon}/></HeartComment>
