  ...
  return (
    <Wrap>
      <Content>
        ...
        {props.index != -1 && <More>더 알아보기</More>}
      </Content>
      {props.index != -1 &&
        (props.check ? (
          <Check src={check} onClick={handleCheck}></Check>
        ) : (
          <Check src={empty} onClick={handleCheck}></Check>
        ))}
      {props.index == -1 &&
        (props.check ? (
          <Check src={check} onClick={handleAllCheck}></Check>
        ) : (
          <Check onClick={handleAllCheck} src={empty}></Check>
        ))}
    </Wrap>
  );
};
